...
<ul class="pagination">
    <li class="waves-effect waves-light btn-small" id="fst"><a href="index.php?action=adminListAllPosts&page=1">First</a></li>
    ...
    <li class="waves-effect waves-light btn-small" id="lst"><a href="index.php?action=adminListAllPosts&page=<?php echo $totalPages; ?>">Last</a></li>
</ul>
