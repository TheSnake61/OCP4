...
<ul class="pagination">
    <li class="waves-effect waves-light btn-small"><a href="index.php?action=listAllPostsPagin&page=1">First</a></li>
    ...
    <li class="waves-effect waves-light btn-small"><a href="index.php?action=listAllPostsPagin&page=<?php echo $totalPages; ?>">Last</a></li>
</ul>
